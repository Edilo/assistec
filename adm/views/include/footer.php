...
script para o efeito nos menus.
<script>
        ...
        function initChart($chart) {
            ...
            var ordersChart = new Chart($chart, {
                ...
                data: {
                    labels: [
<?php
foreach ($this->Dados4 as $qtdTodos):
    echo "'" . $qtdTodos['DESCRICAO'] . "',";
endforeach;
?>
                    ],
                    datasets: [{
            ...
            var salesChart = new Chart($chart, {
                    ...
                    tooltips: {
                        callbacks: {
                            label: function (item, data) {
                                ...
                                content += '<span class="popover-body-value">' + yLabel + ' Qtd.</span>';
                                return content;
                            }
                        }
                    }
                ...
                data: {
                    labels: [
                        <?php
                            echo "'OUT',";
                            foreach($this->Dados7 as $mesG):
                                if($mesG['MES']==1){$msg = "JAN";}
                                if($mesG['MES']==2){$msg = "FEV";}
                                if($mesG['MES']==3){$msg = "MAR";}
                                if($mesG['MES']==4){$msg = "ABR";}
                                if($mesG['MES']==5){$msg = "MAI";}
                                if($mesG['MES']==6){$msg = "JUN";}
                                if($mesG['MES']==7){$msg = "JUL";}
                                if($mesG['MES']==8){$msg = "AGO";}
                                if($mesG['MES']==9){$msg = "SET";}
                                if($mesG['MES']==10){$msg = "OUT";}
                                if($mesG['MES']==11){$msg = "NOV";}
                                if($mesG['MES']==12){$msg = "DEZ";}
                                echo "'".$msg."',";
                            endforeach;
                        ?>
                    ],
